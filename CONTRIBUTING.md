...
2. Run `./bump 1.2.3` to change the version number.
3. Update CHANGELOG.md. Add a new section for the new version.
4. Commit and merge the result.
5. Create a tag using https://github.com/xendit/xendit-components-web/releases/new, setting the release notes to:
   `See [CHANGELOG.md](https://github.com/xendit/xendit-components-web/blob/main/CHANGELOG.md)`
6. Trigger a staging release on the new tag https://asia.buddy.works/xendit/xendit-components-web/pipelines/pipeline/1756/run
...
8. Publish to npm by running https://github.com/xendit/xendit-components-web/actions/workflows/npm-publish.yml, enter the tag name as the input (with v prefix)
