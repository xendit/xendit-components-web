...
const RELEASED_CHANNELS: Record<string, boolean> = {
  ...
  BCA_VIRTUAL_ACCOUNT: true,
  BJB_VIRTUAL_ACCOUNT: true,
  BNI_VIRTUAL_ACCOUNT: true,
  BRI_VIRTUAL_ACCOUNT: true,
  MANDIRI_VIRTUAL_ACCOUNT: true,
  PERMATA_VIRTUAL_ACCOUNT: true,
  BSI_VIRTUAL_ACCOUNT: true,
  CIMB_VIRTUAL_ACCOUNT: true,
  BSS_VIRTUAL_ACCOUNT: true,
  PV_VIRTUAL_ACCOUNT: true,
  VIETCAPITAL_VIRTUAL_ACCOUNT: true,
  WOORI_VIRTUAL_ACCOUNT: true,
  MSB_VIRTUAL_ACCOUNT: true,
  STANDARD_CHARTERED_VIRTUAL_ACCOUNT: true,
  AMBANK_VIRTUAL_ACCOUNT: true,
  BNC_VIRTUAL_ACCOUNT: true,
  MUAMALAT_VIRTUAL_ACCOUNT: true,
  BANK_TRANSFER: true,
  ...
  KBANK_GBW_DIRECT_DEBIT: true,
  DUITNOW_PAY: true,

  VPB_VIRTUAL_ACCOUNT: true,
  BIDV_VIRTUAL_ACCOUNT: true,
  SPEI_VIRTUAL_ACCOUNT: true,
  INA_VIRTUAL_ACCOUNT: true,
};
