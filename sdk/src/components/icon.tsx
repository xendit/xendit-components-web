...
function makeIcon<T extends string>(
  ...
  return { name: id, node: <g id={`xendit-icon-${id}`}>{children}</g> };
}
...
const iconData = [
  ...
  makeIcon(
    "card",
    <>
      <g clip-path="url(#clip0_2759_48714)">
  ...
  makeIcon(
    "dummy",
    <>
      <g clip-path="url(#clip0_2759_48715)">
